...
| `.ralph/prd.json` | Task list for current iteration | During PRD design |
| `.ralph/progress.txt` | Log of what was done each iteration | After each task |
| `.ralph/runs/` | Historical run archives | After completing a PRD |
...
**Task Quality Rules:**
- NO vague tasks: "improve code"
- YES specific tasks: "Add --verbose flag to parse command that shows token breakdown"
...
├── CYCLE.md            <- Current development cycle stage
├── NOTES.md            <- Important user directives & insights
