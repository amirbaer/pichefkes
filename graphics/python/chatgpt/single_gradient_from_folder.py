...
def main(args):
    ...
    palette = get_palette_from_images(args.input_folder)

    if not args.output_folder:
        args.output_folder = os.path.join(args.input_folder, "mixed-gradient")
...
if __name__ == '__main__':
    ...
    parser.add_argument('input_folder', type=str, help='A comma-separated list of colors or a folder of single-color images.')
    parser.add_argument('--output_folder', type=str, default="", help='The output folder where generated images will be saved.')
